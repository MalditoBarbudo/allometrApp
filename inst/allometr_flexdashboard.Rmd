...
lang_flags <- c(
  glue::glue("<img class='flag-image' src='cat.png' width=20px><div class='flag-lang'>%s</div></img>"),
  glue::glue("<img class='flag-image' src='spa.png' width=20px><div class='flag-lang'>%s</div></img>"),
  glue::glue("<img class='flag-image' src='eng.png' width=20px><div class='flag-lang'>%s</div></img>")
)
